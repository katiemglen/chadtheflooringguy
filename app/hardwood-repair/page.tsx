...
const faqSchema = JSON.stringify({ "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [
  ...
  { "@type": "Question", name: "How much does hardwood floor repair cost in Washington County?", acceptedAnswer: { "@type": "Answer", text: "Most hardwood repairs range from $300–$1,200 depending on the scope. Full room refinishing can be $4,000–$8,000+. Chad's targeted approach addresses only the damaged area, saving you significantly. Text photos to 651-353-6238 for a free estimate." } },
      ...
      <main style={{ background: "var(--bg)", minHeight: "100vh" }}>
        ...
        <section style={{ padding: "48px 20px", background: "var(--bg-section)" }}>
          <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
            ...
            <p style={{ fontSize: "1.05rem", color: "var(--text-dim)", lineHeight: 1.7, maxWidth: 600, margin: "0 auto" }}>Full hardwood refinishing runs $3–$8 per sq ft ($4,000–$8,000+ per room). Targeted board replacement or spot repair typically costs $300–$1,200 — addressing only the damaged area.</p>
          </div>
        </section>

/**
 * SEOContent — Server-rendered hidden content for crawlers.
 * This renders in the root layout so every page gets crawlable text.
 * Must be updated whenever site content changes.
 */
  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li><strong>Flooring Installation</strong> — New carpet, LVP, hardwood, and engineered wood installation. Full rooms, basements, and remodels. Flooring installation Woodbury MN.</li>
      </ul>
      ...
      <h2>How to Get Your Fastest Quote</h2>
      <p><strong>Step 1 — Send Photos:</strong> Text several pictures of the flooring area(s) that need repair from different angles, along with your first and last name, to 651-353-6238.</p>
      <p><strong>Step 2 — Get a Free Quote:</strong> Chad reviews your photos and responds with a free estimate — usually same day. No site visit required for initial estimates.</p>
      <p>Chad loves to talk and share information. He&apos;ll get back with a free quote and help answer your questions.</p>

      <h2>Contact Chad the Flooring Guy</h2>
      <p>Call or text: <a href="tel:6513536238">651-353-6238</a> (Monday–Friday, 7:00 AM–5:00 PM)</p>
      <p>Fastest quote: Text photos of your flooring from different angles + your first and last name to 651-353-6238.</p>
      <p>We respond within 24 hours. No site visit required for initial estimates.</p>
      <p>Insured · 20+ years experience · Anthony Marie LLC · Woodbury, MN</p>
      <p>&ldquo;Thank you for the love + support! We are so blessed by a wonderful community of happy people!&rdquo; — Chad &amp; Katie</p>
      ...
      <dl>
        ...
        <dd>Text several photos of the flooring area from different angles plus your first and last name to 651-353-6238. Chad reviews photos and responds with a free estimate, usually same day.</dd>
        <dt>Are you insured?</dt>
        <dd>Yes. Chad is fully insured through Anthony Marie LLC with 20+ years of experience.</dd>
        <dt>Do you do new flooring installations too?</dt>
        <dd>Yes — carpet, LVP, hardwood, and engineered wood. Full rooms, basements, and remodels. But Chad&apos;s specialty is targeted repairs that save you from unnecessary full replacements.</dd>
      </dl>

      <nav aria-label="Site navigation">
        <ul>
          <li><a href="/">Home</a></li>
          <li><a href="/carpet-repair-woodbury">Carpet Repair</a></li>
          <li><a href="/lvp-repair-stillwater">LVP Repair</a></li>
          <li><a href="/hardwood-repair">Hardwood Repair</a></li>
          <li><a href="/transition-repair">Transition Repair</a></li>

...
async function seedData(ctx: any) {
  ...
  const services = [
    {
      ...
      priceRange: "$350–$650 · Challenging repairs up to $800–$1,000 (rare, reviewed by Chad)",
      tier: "primary",
      sortOrder: 1,
      active: true,
    },
    {
      ...
      description: "Wrinkles, buckling, and loose carpet? Re-stretching brings your carpet back to life. Especially common in newer homes where carpet wasn't mechanically stretched during installation. Re-stretching covers more surface area with many moving parts — every job is unique.",
      ...
      priceRange: "Estimate based on job scope — contact Chad for a quote",
      tier: "primary",
      sortOrder: 2,
      active: true,
    },
    ...
    },
    {
      ...
      description: "Luxury Vinyl Plank installation for any room. Durable, water-resistant, and beautiful. Chad ensures proper clicking, expansion gaps, and transitions so your floors last. Important: LVP is water-resistant, not waterproof — the planks themselves resist moisture, but the locking system between boards can allow spills to seep through to the subfloor. Clean up spills quickly and you'll be golden!",
      shortDescription: "Durable, water-resistant, beautiful",
      icon: "✨",
      features: ["Any room or whole house", "Water-resistant flooring", "Proper installation technique", "Material sourcing help", "Transition work included"],
      tier: "standard",
      sortOrder: 5,
      active: true,
    },
    {
      ...
      description: "Full room or whole house carpet installation. Chad helps you source the best materials at the best price and installs with proper mechanical stretching — the way it should be done. Please note: all furniture and objects must be removed from the room before installation — no exceptions. If there are large or heavy items, we'll discuss an action plan together!",
      shortDescription: "Full rooms, full house, done right",
      icon: "🏠",
      features: ["Full room install", "Whole house projects", "Material sourcing help", "Proper mechanical stretching", "⚠️ Homeowner responsible for furniture removal"],
      tier: "standard",
      sortOrder: 6,
      active: true,
    },
  ...
  const testimonials = [
    { name: "Sarah M.", text: "Chad re-stretched our carpet and it looks brand new! We had wrinkles in every room from a bad original install. He was professional, explained everything, and priced fairly. Can't recommend him enough!", rating: 5, source: "Nextdoor", neighborhood: "Woodbury", featured: true, active: true, sortOrder: 1 },
    { name: "Mike & Jenny T.", text: "Our dog destroyed the carpet by the back door. We thought we'd need to replace the whole room. Chad patched it and you literally cannot tell. Saved us thousands. The repair guy is REAL.", rating: 5, source: "Nextdoor", neighborhood: "Oakdale", featured: true, active: true, sortOrder: 2 },
    { name: "Lisa R.", text: "We moved into our new build and the LVP was already clicking and had scratched boards. Chad came out, explained what went wrong during install, and fixed everything. So glad someone recommended him on Nextdoor!", rating: 5, source: "Nextdoor", neighborhood: "Woodbury", featured: true, active: true, sortOrder: 3 },
    { name: "Tom K.", text: "I've been trying to find someone to fix my carpet seams for months. Nobody does repairs anymore. Found Chad on Nextdoor and he had it done in two hours. Fair price, great work, even better personality.", rating: 5, source: "Nextdoor", neighborhood: "Cottage Grove", featured: true, active: true, sortOrder: 4 },
    { name: "Amanda P.", text: "Chad installed LVP in our entire main floor. He helped us pick the right material, got us a great deal, and the install was flawless. He even educated us on maintenance. Five stars all day!", rating: 5, source: "Google", neighborhood: "Woodbury", active: true, sortOrder: 5 },
    { name: "Dave & Carol H.", text: "Katie was great with communication and scheduling, and Chad's work speaks for itself. We had carpet installed in 3 bedrooms and the quality is outstanding. A real team effort — love these two!", rating: 5, source: "Facebook", neighborhood: "Lake Elmo", active: true, sortOrder: 6 },
  ];
  ...
  const faqs = [
    ...
    { question: "How much do repairs typically cost?", answer: "Most repairs run $350–$800 and take 2-3 hours. The exact price depends on the type of repair, size of the area, and materials needed. Send photos through the bid form for the fastest estimate!", category: "pricing", sortOrder: 4, active: true },
  ...
  const tips = [
    ...
    { title: "LVP Isn't Invincible", content: "Luxury Vinyl Plank is durable, but it's water-resistant — not waterproof. The planks themselves may resist moisture, but the locking system between boards can let spills seep through to the subfloor. Clean up spills quickly! Also, heavy furniture, pet nails, and improper installation can cause scratches, chips, and clicking. The good news: individual boards can usually be replaced without redoing the whole floor.", icon: "💡", sortOrder: 3, active: true },
...
export const reseed = mutation({
  handler: async (ctx) => {
    for (const table of ["siteConfig", "services", "testimonials", "faqs", "tips"] as const) {
